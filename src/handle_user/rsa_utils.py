...
def save_rsa_keys(printer, private_key, public_key, username):
	"""Saves the RSA public and private key to data/keys/username."""
	public_key_path = f"data/keys/{username}/{username}_public_key.pem"
	private_key_path = f"data/keys/{username}/{username}_private_key.pem"
